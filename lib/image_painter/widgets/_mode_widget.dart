...
import 'package:qulip/image_painter/_image_painter.dart';
...
List<ModeData> surveyFormModes(TextDelegate textDelegate) => [
      ModeData(
          icon: Icons.crop_free,
          mode: PaintMode.rect,
          label: textDelegate.rectangle),
...
List<ModeData> verticalFormArrowModes(TextDelegate textDelegate) => [
      //
      ModeData(
          icon: Icons.arrow_right_alt_outlined,
          mode: PaintMode.arrow,
...
List<ModeData> horizontalFormArrowModes(TextDelegate textDelegate) => [
      ModeData(
          icon: Icons.text_format,
          mode: PaintMode.text,
          label: textDelegate.text),
