...
class SurveyCanvas extends StatefulWidget {
  const SurveyCanvas({super.key});

  @override
  State<SurveyCanvas> createState() => _SurveyCanvasState();
}

class _SurveyCanvasState extends State<SurveyCanvas> {
              ...
              MyButton(
                ...
                onTap: () async {
                  ...
                  saveImage().then((value) {
                    ...
                    controller.canvasSurveyUrl.value = value!;
                    setState(() {
                      file = null;
                    });
  ...
  Future<String?> saveImage() async {
    if (_imageKey.currentState != null) {
      ...
      File file = File(
          "${tempDir.path}/SN_CANVAS_${DateTime.now().millisecondsSinceEpoch}.png");
      ...
      if (data != null) {
        ...
        var ref = FirebaseStorage.instance
            .ref()
            .child('canvas')
            .child("SN_CANVAS_${DateTime.now().millisecondsSinceEpoch}.png");
